let todoList = {  
   ...
   let view = {  
    ...
    createCheckbox: function() {  
     ...
     let checkboxState = document.createElement('div');  
    ...
    checkTodosCompletion: function() {  
     ...
     let totalTodos = todoList.todos.length;  
     let completedTodos = 0;  
     ...
     let todosLeftLabel = document.getElementById('todosLeft');  
     todoList.todos.forEach(function(todo) {  
      if (todo.completed === true) {  
       completedTodos++;  
      }  
    ...
    getTodoElementIndex: function(todoElement) {  
     ...
     let todo = todoList.todos.find(function(todo) {  
    ...
    resizeTodos: function() {  
     if (window.matchMedia('(max-device-width: 680px)').matches) { 
      ...
      let todoAppWidth = document.getElementById('todoApp').offsetWidth;  
      let todoTextWidth = todoAppWidth - 100 + 'px';  
    ...
    setUpEventListeners: function() {  
     let addTodoTextInput = document.getElementById('addTodoTextInput');  
     let todoMenu1 = document.getElementById('todoMenu1');  
     let todosUl = document.getElementById('todos');  
     ...
     todosUl.addEventListener('click', function(event) {  
      ...
      // Check if elementClicked is a checkbox.  
       ...
       // Get index using getTodoElementIndex function.  
       let indexOfTodoElement = view.getTodoElementIndex(elementClicked.parentNode.parentNode);  
